...
//Questão 16
function obterNota(mensagem: string | undefined) {
    let nota;
    do {
...
function getNota(index: number): number {
...
//Questão 23
function calcularMediaAlturas(): void {
    let somaAlturas = 0;
...
//Questão 25
function somaDigitosPares(): void {
